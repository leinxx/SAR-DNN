...
template <typename Dtype>
void write_blob_to_uint8_image(const string& filename, const Blob<Dtype>* blob, const int num = -1, const int channel = -1, const Dtype scale = 1, const int min_val = 0, const int max_val = 255);
}  // namespace caffe

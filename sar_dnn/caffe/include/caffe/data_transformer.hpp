...
class DataTransformer {
 public:
  ...
  void Transform(const Datum& datum, Blob<Dtype>* transformed_blob,
                Datum* label_dim = NULL , Blob<Dtype>* transformed_label = NULL);
  ...
  vector<Dtype> mean_values() {return mean_values_;}
  vector<Dtype> scale_values() {return scale_values_;}
 protected:
   /**
  ...
  void Transform(const Datum& datum, Dtype* transformed_data,
                 const Datum* label_datum = NULL, Dtype* transformed_label = NULL);

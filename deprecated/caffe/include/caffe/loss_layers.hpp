...
class L1LossLayer: public LossLayer<Dtype> {
 public:
  ...
  virtual inline const char* type() const { return "L1LossLayer"; }
  virtual inline int ExactNumTopBlobs() const { return -1; }
  virtual inline int MinTopBlobs() const { return 1; }
  virtual inline int MaxTopBlobs() const { return 2; }
...
template <typename Dtype>
class ConstrainLossLayer: public LossLayer<Dtype> {
 public:
  explicit ConstrainLossLayer(const LayerParameter& param)
      : LossLayer<Dtype>(param), diff_() {}
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);

  virtual inline const char* type() const { return "ConstrainLossLayer"; }
  virtual inline int ExactNumTopBlobs() const { return -1; }
  virtual inline int MinTopBlobs() const { return 1; }
  virtual inline int MaxTopBlobs() const { return 2; }
